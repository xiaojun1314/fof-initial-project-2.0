  ...
  const fetchUserInfo = async () => {
    ...
    if (data.currentUser) {
      setInitialState({
        ...
        leafMenuData: data.leafMenuData,
        elementCodeData: data.elementCodeData,
      });
    }
  };
        ...
        <div className={styles.top}>
          <div className={styles.header}>
            <Link to="/">
              ...
              <span className={styles.title}>平台测试中.......</span>
            </Link>
          </div>
          <div className={styles.desc}>企业级产品设计体系，创造高效愉悦的工作体验</div>
        </div>
